...
@implementation APINotesApiClient
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key
    ...
    [_serviceClients setObject:[[APINotesApiClient alloc] initWithConfiguration:configuration withUrl:url]
                        forKey:key];
}
